...
export const TrailerJoint = ({body, trailer}: {
  body: RefObject<RapierRigidBody>,
  trailer: RefObject<RapierRigidBody>
}) => {
  const joint = useRevoluteJoint(body, trailer, [[0, 0, 0], [0, 0, 0], [0, 1, 0]])
